...
:url-repo: https://github.com/hyperpolymath/asdf-haproxy-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-haproxy-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-haproxy-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-haproxy-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Haproxy] versions.
...
Haproxy is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Haproxy versions per project

|**Project Isolation**
|Pin Haproxy per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Haproxy version
...
=== Installing Haproxy Versions

[source,bash]
----
asdf list all haproxy
asdf install haproxy latest
asdf install haproxy 0.1.0
----
...
[source,bash]
----
asdf global haproxy 0.1.0
asdf local haproxy 0.1.0
asdf current haproxy
haproxy --version
----
...
* Ensure `haproxy` is on PATH after installation.
* Verify the installed version with `haproxy --version`.
